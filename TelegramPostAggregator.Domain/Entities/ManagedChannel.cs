...
public sealed class ManagedChannel : BaseEntity
{
    ...
    public bool TrackPostEdits { get; set; }
    public DateTimeOffset? TrackPostEditsEnabledAtUtc { get; set; }
    ...
    public ICollection<ManagedChannelPostTracking> TrackedPostDeliveries { get; set; } = new List<ManagedChannelPostTracking>();
}
